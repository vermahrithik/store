...
class _ProductListPageState extends State<ProductListPage> {
                                              ...
                                              decoration: BoxDecoration(
                                                borderRadius:
                                                    BorderRadius.circular(
                                                        12.sp),
                                                // You can add a color or a background if needed
                                              ),
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: 10.0),
                                              child: Text(
                                                showproducts[index].name.toString(),
                                                  style: TextStyle(
                                                      fontSize: 14.sp,
                                                      fontWeight:
                                                          FontWeight.w500),
  ...
  // void getPrefs() async {
  //   prefScan = await SharedPreferences.getInstance();
  // }
}
